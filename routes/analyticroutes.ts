...
import { getRoomsBookedPerDay,getAverageCompanyBookingForMonthandYear, getAverageMealsBoughtPerDay, getAverageBreakfastBoughtPerDay, getRoomsBookedPerDayQuarter, getAverageCompanyBookingForQuarterandYear, getAverageMealsBoughtPerDayQuarter, getAverageBreakfastBoughtPerDayQuarter, getRoomsBookedPerDayYear, getAverageCompanyBookingForYear, getAverageMealsBoughtPerDayYear, getAverageBreakfastBoughtPerDayYear } from "../controllers/analyticscontroller";
const router = Router();
